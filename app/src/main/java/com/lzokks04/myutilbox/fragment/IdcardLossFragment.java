 ...
 */
public class IdcardLossFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_idcard_loss, container, false);
    ...
    private void getData(String id, String type, String key) {
        ...
        service.getIdLoss(id, type, key)
                .subscribeOn(Schedulers.io())
                .observeOn(AndroidSchedulers.mainThread())
                .subscribe(new Subscriber<IdcardLostBean>() {
                    @Override
                    ...
                    @Override
                    public void onNext(IdcardLostBean idcardLostBean) {
                        tvId.setText("身份证号码:" + idcardLostBean.getResult().getCardno());
                        tvStatus.setText("状态:" + idcardLostBean.getResult().getTips());
                    }
                });
    }
}
